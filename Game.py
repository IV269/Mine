...
class Game:
    ...
    def draw_hp(self):
        ...
        for i in range(self.hp):
            ...
            self.screen.blit(image, (self.width - self.hp * 40 + i * 40, 5))
    ...
    def draw_coins(self):
        ...
        image = pygame.transform.scale(image, (32, 32))
        self.screen.blit(image, (self.width - 32, 50))

        text = pygame.font.Font(None, 45).render(str(self.coins), 1, (0, 0, 0))
        self.width_text = text.get_width() + 32
        self.screen.blit(text, (self.width - text.get_width() - 32, 53))

    def draw_header(self):
        '''Функция рисующая заголовок'''
        pygame.draw.rect(self.screen, (0, 0, 0), (min(self.width - self.width_text - 5,
                                                      self.width - self.hp * 40 - 5),
                                                  -5, max(self.width_text + 5, self.hp * 40 + 5), 100), 5)
        self.draw_hp()
        self.draw_coins()
    ...
    def draw_waves(self):
        ...
        self.screen.blit(text, (self.width // 2 - text.get_width() // 2, 23))
        pygame.draw.rect(self.screen, (0, 0, 0), (self.width // 2 - text.get_width() // 2 - 5,
                                                  -5, text.get_width() + 10, 80), 5)
    ...
    def tower_place_detect_mouse(self, pos: tuple) -> map:
